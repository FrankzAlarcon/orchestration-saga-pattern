...
public class OrderServiceImpl implements OrderService {
    ...
    public Order placeOrder(Order order) {
        ...
        logger.info("Sending order created event to Kafka topic: " + ordersEventsTopicName);

        kafkaTemplate.send(ordersEventsTopicName, placedOrder);
        logger.info("Order created event sent to Kafka topic: " + ordersEventsTopicName);
    ...
    public void approveOrder(UUID orderId) {
        ...
        logger.info("Order approved event sent to Kafka topic: " + ordersEventsTopicName);
    }
    ...
    public void rejectOrder(UUID orderId) {
        ...
        orderRepository.save(orderEntity);
        logger.info("Order rejected: {} with status: {}", orderId.toString(), orderEntity.getStatus().toString());
    }
